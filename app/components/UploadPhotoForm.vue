    ...
    <div>
      ...
      <div class="grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2">
        ...
        <div class="lg:col-span-4">
          ...
          <Textarea v-model="photo.semanticDescription" />
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2">
        ...
        <div>
          ...
          <Input v-model.number="photo.focalLength" type="number" />
        </div>
        <div>
          <Label class="text-sm font-medium">等效35mm焦距</Label>
          <Input v-model.number="photo.focalLengthIn35mmFormat" type="number" />
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2">
        <div>
          ...
          <Input v-model.number="photo.fNumber" type="number" step="0.1" />
        </div>
        <div>
          <Label class="text-sm font-medium">ISO</Label>
          <Input v-model.number="photo.iso" type="number" />
        </div>
        <div>
          <Label class="text-sm font-medium">快门速度</Label>
          <Input v-model.number="photo.exposureTime" type="number" step="0.001" />
        </div>
        <div>
          <Label class="text-sm font-medium">曝光补偿</Label>
          <Input v-model.number="photo.exposureCompensation" type="number" step="0.1" />
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2">
        ...
        <div>
          ...
          <Input v-model.number="photo.latitude" type="number" step="0.000001" />
        </div>
        <div>
          <Label class="text-sm font-medium">经度</Label>
          <Input v-model.number="photo.longitude" type="number" step="0.000001" />
        </div>
        <div>
